...
class V1alpha3PodSchedulingContextList(BaseModel):
    ...
    items: List[V1alpha3PodSchedulingContext] = Field(description="Items is the list of PodSchedulingContext objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1alpha3PodSchedulingContext.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
