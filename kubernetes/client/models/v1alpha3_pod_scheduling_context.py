...
class V1alpha3PodSchedulingContext(BaseModel):
    ...
    status: Optional[V1alpha3PodSchedulingContextStatus] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1alpha3PodSchedulingContextSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": V1alpha3PodSchedulingContextStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
