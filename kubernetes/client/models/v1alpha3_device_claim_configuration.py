...
class V1alpha3DeviceClaimConfiguration(BaseModel):
    ...
    requests: Optional[List[StrictStr]] = Field(default=None, description="Requests lists the names of requests where the configuration applies. If empty, it applies to all requests.")
