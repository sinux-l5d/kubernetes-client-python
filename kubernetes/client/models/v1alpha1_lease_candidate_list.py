...
class V1alpha1LeaseCandidateList(BaseModel):
    ...
    items: List[V1alpha1LeaseCandidate] = Field(description="items is a list of schema objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1alpha1LeaseCandidate.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
